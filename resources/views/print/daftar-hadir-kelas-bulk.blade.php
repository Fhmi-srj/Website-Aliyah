    ...
    @foreach($sections as $idx => $section)
        <div class="{{ $idx > 0 ? 'section-break' : '' }}">
            ...
            <div class="info-line">
                <div class="info-item">
                    <strong>Kelas:</strong>
                    <span>{{ $section['kelas']->nama_kelas ?? '-' }}</span>
                </div>
                <div class="info-item">
                    <strong>Bulan:</strong>
                ...
                <div class="info-item">
                    ...
                    <span>{{ $section['kelas']->waliKelas->nama ?? '-' }}</span>
                </div>
            </div>
                ...
                <div class="signature-row">
                    <div class="signature-box">
                        ...
                        <div class="signature-space">
                            @if(isset($section['qrCode']))
                                <img src="{{ $section['qrCode'] }}" alt="QR Verifikasi" class="qr-code-img">
                            @endif
                        </div>
                    ...
                    <div class="signature-box">
                        ...
                        <p>Wali Kelas</p>
                        <div class="signature-space">
                            @if(isset($section['qrWaliKelas']))
                                <img src="{{ $section['qrWaliKelas'] }}" alt="QR Wali Kelas" class="qr-code-img">
                            @endif
                        </div>
                        <p class="signature-name">{{ $section['kelas']->waliKelas->nama ?? '.........................' }}</p>
                        @if($section['kelas']->waliKelas->nip ?? false)
                            <p class="signature-nip">NIP. {{ $section['kelas']->waliKelas->nip }}</p>
                        @endif
                    </div>
                </div>
            </div>
